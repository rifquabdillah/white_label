...
class detailRedeemPoin extends StatefulWidget {
  const detailRedeemPoin({super.key, required String redeemValue, });

  @override
  _detailRedeemPoinState createState() => _detailRedeemPoinState();
}

class _detailRedeemPoinState extends State<detailRedeemPoin> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Center(
            child: Text(
              'Selamat, poin kamu udah diredeem ke saldo',
              style: TextStyle(
                fontSize: 14,
  ...
  Widget _buildPoinDetails() {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildDetailRow('Saldo Awal', '2.812.590'),
          _buildDetailRow('Penambahan dari Komisi', '50.000'),
